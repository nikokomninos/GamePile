    ...
    return (
        <div>
            <div className="relative flex items-center justify-center
                ...
                <h1 className="font-lato font-bold text-xs flex justify-center items-center gap-1">{<BiSolidCategoryAlt size="12" />} Category</h1>
            </div>

            <div className="p-4">
                <h1 className="font-lato font-bold text-4xl pb-10 text-center">{state.category}</h1>
                <ul className="flex flex-wrap justify-center">
                    {state.categoryList.map((_, index) => (
                        <GameCover key={index}
