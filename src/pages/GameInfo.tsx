...
const GameInfo = () => {
  ...
  const addGameToCategory = async (category: String) => {
    try {
      await invoke("db_add_game", {
        ...
        desc: state.desc,
        cover: state.cover,
        platforms: state.platforms.map((platform: any) => platform.name),
  ...
  return (
    <div className="font-lato">
      ...
      >
        <h1
          className="font-bold text-xs flex justify-center
                               items-center gap-2"
        >
          {<IoLogoGameControllerB size="12" />}Game
        </h1>
      </div>
      ...
      <div className="font-lato">
        <div className="relative w-full h-100 overflow-hidden">
          ...
          <div className="relative z-10 flex items-end justify-between h-full p-4">
            ...
            <img
              src={state.cover}
              className="w-50 rounded-xl drop-shadow-2xl"
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="flex flex-col items-end justify-end pr-4">
            <div className="bg-neutral-800 w-50 h-full p-4 mb-3 rounded-lg text-sm">
              <h1 className="flex justify-center items-center font-bold mb-5">
                Platforms
              </h1>
              <ul className="list-disc pl-5">
                {state.platforms?.map((platform: any, index: number) => (
                  <li key={index} className="mb-2 gap-2">
            ...
            <div
              className="flex flex-col bg-neutral-800 w-50 h-full p-4
            ...
            >
              ...
              <ul>
                <button
                  onClick={() => addGameToCategory("want_to_play")}
                  className="flex items-center justify-center
                                               bg-neutral-700 w-30 h-6
                                               rounded-lg font-bold mb-2
                                               transition-all duration-100
                                               ease-linear hover:bg-neutral-600
                                               hover:rounded-sm cursor-pointer"
                >
                  Want To Play
                </button>

                <button
                  onClick={() => addGameToCategory("playing")}
                  className="flex items-center justify-center
                                               bg-neutral-700 w-30 h-6
                                               rounded-lg font-bold mb-2
                                               transition-all duration-100
                ...
                <button
                  onClick={() => addGameToCategory("beaten")}
                  className="flex items-center justify-center
                                               bg-neutral-700 w-30 h-6
                                               rounded-lg font-bold mb-2
                                               transition-all duration-100
                ...
                <button
                  onClick={() => addGameToCategory("on_hold")}
                  className="flex items-center justify-center
                                               bg-neutral-700 w-30 h-6
                                               rounded-lg font-bold mb-2
                                               transition-all duration-100
                ...
                <button
                  onClick={() => addGameToCategory("abandoned")}
                  className="flex items-center justify-center
                                               bg-neutral-700 w-30 h-6
                                               rounded-lg font-bold mb-2
                                               transition-all duration-100
            ...
            >
              <button
                onClick={() => removeGameFromBacklog()}
                className="flex items-center justify-center bg-neutral-700 h-12
